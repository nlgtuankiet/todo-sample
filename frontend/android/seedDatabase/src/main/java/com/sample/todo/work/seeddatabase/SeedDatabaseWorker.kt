...
import com.sample.todo.work.seeddatabase.service.SeedControllerService
...
class SeedDatabaseWorker @AssistedInject constructor(
    ...
    private val params: com.sample.todo.work.seeddatabase.Parameter by lazy { com.sample.todo.work.seeddatabase.Parameter.fromData(workerParams.inputData) }
    ...
    interface Factory : com.sample.todo.work.ListenableWorkerFactory {
