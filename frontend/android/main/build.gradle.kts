...
dependencies {
    ...
    api(project(":frontend:android:main:tasks"))
    implementation(project(":frontend:android:domain"))
    implementation(project(":frontend:android:main:mainNavigation"))
    implementation(project(":frontend:android:base"))
    api(project(":frontend:android:main:taskdetail"))
    api(project(":frontend:android:main:about"))
    api(project(":frontend:android:main:addedit"))
    api(project(":frontend:android:main:search"))
    api(project(":frontend:android:main:setting"))
    api(project(":frontend:android:main:statistics"))
