...
import com.sample.todo.main.taskdetail.library.domain.interactor.DeleteTask
import com.sample.todo.main.taskdetail.library.domain.interactor.GetTaskObservable
import com.sample.todo.main.taskdetail.library.domain.interactor.UpdateComplete
...
class TaskDetailViewModel @Inject constructor(
    ...
    private val getTaskObservable: GetTaskObservable,
    ...
    val currentTask = getTaskObservable(TaskId(args.taskId))
        .doOnNext {
