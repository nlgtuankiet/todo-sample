...
class FirestoreDataSource(
    ...
    override fun loadInitial(
        ...
        baseQuery.limit(params.requestedLoadSize.toLong())
            ...
            .get(source)
            .addOnSuccessListener(FireStore.executor, object : FirestoreDataSource.OnLoadSuccessListener() {
            ...
            .addOnFailureListener(FireStore.executor, object : FirestoreDataSource.OnLoadFailureListener() {
