...
class QueryFactory private constructor(
     ...
     */
    fun create(): Query =
        filters.fold(collectionReference as Query) { query, filter -> filter.apply(query) }
    ...
    private abstract class Filter(
        ...
        private class OrderByFilter(
            ...
            override fun applyReverse(query: Query): Query =
                query.orderBy(fieldPath, reverseDirection)
        }
        ...
        companion object {
            @JvmStatic
            fun orderBy(fieldPath: FieldPath, direction: Query.Direction): Filter =
                Filter.OrderByFilter(fieldPath, direction)
            ...
            fun whereGreaterThanOrEqualTo(fieldPath: FieldPath, value: Any): Filter =
                ByValueFilter(
                    fieldPath,
                    value
                ) { p, v -> whereGreaterThanOrEqualTo(p, v) }
            ...
            fun whereLessThanOrEqualTo(fieldPath: FieldPath, value: Any): Filter =
                ByValueFilter(
                    fieldPath,
                    value
                ) { p, v -> whereLessThanOrEqualTo(p, v) }
    ...
    class Builder(private val collection: CollectionReference) {
         ...
         */
        @JvmOverloads
        fun orderBy(field: String, direction: Query.Direction = ASCENDING) =
            orderBy(FieldPath.of(field), direction)
        ...
        fun whereGreaterThan(field: String, value: Any) =
            whereGreaterThan(FieldPath.of(field), value)
        ...
        fun whereGreaterThanOrEqualTo(field: String, value: Any) =
            whereGreaterThanOrEqualTo(FieldPath.of(field), value)
        ...
        fun whereLessThanOrEqualTo(field: String, value: Any) =
            whereLessThanOrEqualTo(FieldPath.of(field), value)
        ...
        fun whereArrayContains(field: String, value: Any) =
            whereArrayContains(FieldPath.of(field), value)
