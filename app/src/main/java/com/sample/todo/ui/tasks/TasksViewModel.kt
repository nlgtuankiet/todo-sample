...
class TasksViewModel @AssistedInject constructor(
    @Assisted private val initialState: TasksState,
    ...
    interface Factory : ViewModelFactory<TasksViewModel, TasksState>
    ...
    init {
        ...
        getAllTaskMini().execute {
            val pagedList = it() ?: return@execute this
            copy(
                isNoTasks = pagedList.isEmpty(),
                tasksMini = pagedList
            )
        }
    }
